...
```bash
curl -sk --proxy http://127.0.0.1:28880 "https://daoyu.fan/api/v1/member/profile?token=local-test"
```
...
5. 发送正例请求：
   ...
   ```bash
   curl -skL --proxy http://127.0.0.1:28880 "https://daoyu.fan/4687.html"
   ```
...
7. 发送负例请求：
   ...
   ```bash
   curl -sk --proxy http://127.0.0.1:28880 "https://daoyu.fan/app.js"
   ```
...
```bash
curl -skL --proxy http://127.0.0.1:28880 "https://daoyu.fan/57517.html" -o /tmp/daoyu-57517.html
